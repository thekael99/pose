...
class ResNet(nn.Module):
    ...
    def _upsample(self):
        layers = [
            nn.ConvTranspose2d(2048, 128, 5, stride=4, padding=1, output_padding=1),
            nn.Conv2d(128, 8, kernel_size=5, stride=1, padding=2, bias=False),
...
class Distance(nn.Module):
    def __init__(self):
        ...
        self.downsample1 = nn.Sequential(
            nn.Conv2d(4096, 128, kernel_size=3, padding=1, stride=1),
            nn.BatchNorm2d(128))
        self.block1 = Block(4096, 128, i_downsample=self.downsample1)
